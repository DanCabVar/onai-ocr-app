...
|---|---|---|---|---|
| SPEC-00 | `03_specs/active/SPEC-00_plan_maestro.md` | Activo transversal | 2026-05-27 | Pull + sincronizaciÃ³n MC2; snapshot completo en `docs/06_history/MC2_TASKS_OCR_AI_2026-05-27.md`. |
| T08 / SPEC-01 | `03_specs/active/SPEC-01_rag_seguro_multitenant.md` | En revisiÃ³n | 2026-05-27 | MC2 lo marca done; falta auditorÃ­a DB/cÃ³digo antes de cerrar en harness. |
...
| T02 / SPEC-03 | `03_specs/active/SPEC-03_r2_cleanup.md` | Disponible | 2026-05-27 | MC2 mantiene pendiente script one-shot para limpiar legacy `extracted/`; requiere dry-run y aprobaciÃ³n para delete. |
| T05 / SPEC-04 | `03_specs/active/SPEC-04_planes_stripe_billing.md` | En revisiÃ³n | 2026-05-27 | MC2 marca pricing/Stripe/lÃ­mites como done; quedan oferta Enterprise y decisiones comerciales/facturaciÃ³n. |
| T06 / SPEC-05 | `03_specs/active/SPEC-05_admin_dashboard.md` | En revisiÃ³n | 2026-05-27 | MC2 contiene tarea dashboard admin done; verificar existencia/rutas/permisos en cÃ³digo. |
| T04 / SPEC-06 | `03_specs/active/SPEC-06_ci_cd_deploy.md` | En revisiÃ³n | 2026-05-27 | CI/CD real por GHCR + SSH; revisar contradicciones restantes. |
...
| T07 / SPEC-08 | `03_specs/active/SPEC-08_onboarding.md` | Backlog | 2026-05-27 | Depende de UX producto; no aparece como pendiente MC2 explÃ­cito. |
| T09 / SPEC-09 | `03_specs/active/SPEC-09_dominio_produccion.md` | Requiere decisiÃ³n usuario | 2026-05-27 | MC2 mantiene pendiente SSL/dominio propio `onaiconsulting.cl` o `onai.cl`. |
