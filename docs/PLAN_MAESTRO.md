...
| T23 | Alta | Estandarizar configuraciÃ³n ESLint (frontend + backend) | En trabajo por agente | `docs/03_specs/active/SPEC-23_estandarizar_eslint_config.md` | Debe evitar refactor masivo y partir con baseline pragmÃ¡tico | Config ESLint versionada + CI ejecutando lint obligatorio en ambos proyectos | ImplementaciÃ³n funcional en rama `codex/spec-23-estandarizar-eslint-config`; mantener `deploy/all-features` en docs-only hasta validaciÃ³n/merge |
