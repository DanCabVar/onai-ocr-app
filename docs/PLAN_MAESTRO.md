...
| T23 | Alta | Estandarizar configuraci�n ESLint (frontend + backend) | En revisi�n | `docs/03_specs/active/SPEC-23_estandarizar_eslint_config.md` | Baseline aplicada; pendiente decisi�n de merge/cierre y endurecimiento progresivo de reglas | Config ESLint versionada + CI ejecutando lint obligatorio en ambos proyectos | Revisar PR de `codex/spec-23-estandarizar-eslint-config` y definir cierre de SPEC-23 / fase 23.1 |
