...
| T14 | Alta | Carga paralela de archivos + progreso real por archivo | En trabajo por agente | `docs/03_specs/active/SPEC-14_carga_paralela_archivos.md` | Validacion manual de throughput 20+ y evidencia antes/despues pendiente | Throughput mejorado, estado por archivo en UI y reporte benchmark T14 | Ejecutar benchmark reproducible y cerrar evidencia en `docs/04_trabajo/T14_carga_paralela_archivos/` |
| T15 | Media | Agente QA automatizado con Playwright | En revision | `docs/03_specs/active/SPEC-15_agente_qa_playwright.md` | Credenciales E2E faltantes para smoke autenticado completo en CI | Suite E2E smoke + artifacts + runbook QA | Configurar secrets E2E en GitHub Actions y validar corrida completa (auth/upload/delete) |
...
| T23 | Media | Estandarizar configuracion ESLint | Backlog | `docs/03_specs/active/SPEC-23_estandarizar_eslint_config.md` | Coordinar reglas entre frontend/backend sin romper CI | Config ESLint homogenea + guia de uso | Definir baseline de reglas y plan de adopcion incremental |
