...
| T28 | Alta | Calidad y consistencia del chatbot documental | Disponible para agente | `docs/03_specs/active/SPEC-28_calidad_chatbot_documental.md` | Nace de validación QA de `T20`; requiere benchmark semántico, catálogo de intenciones y resolución robusta de campos para documentos actuales y nuevos | Estrategia robusta de chatbot + benchmark versionado + regresiones automáticas | Ejecutar fase 1: catálogo de intenciones, benchmark base y matriz campo→sinónimos antes de ampliar nuevas rutas determinísticas |
