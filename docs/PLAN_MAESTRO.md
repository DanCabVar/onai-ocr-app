...
| T24 | Alta | RAG híbrido sobre Markdown grafo (Obsidian-ready) | Disponible para agente | `docs/03_specs/active/SPEC-24_rag_hibrido_markdown_grafo_obsidian.md` | Depende de outputs de SPEC-21 y control estricto de aislamiento por tenant | Retrieval híbrido con trazabilidad de fuentes desde respaldos Markdown | Implementar parser/index/retrieval v1 con degradación segura al RAG actual |
